...
function DataInMemory()
{
	...
	{
		me.retrieveFromMemory( me.dataElementOptionSets, 'id', optionSetId, _queryURL_OptionSets + optionSetId + '.json?fields=id,displayName,options[id,displayName,displayName]', function( dataObj )
		{
			runFunc( dataObj );
		});
	}
